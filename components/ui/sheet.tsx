 ...
 * - `SheetPortal`: The container that renders the sheet and its overlay.
 ...
 *
 * The `Sheet` component uses the `class-variance-authority` library to apply CSS classes based on the specified `side` prop, which determines the sheet's position on the screen.
 */
"use client";
