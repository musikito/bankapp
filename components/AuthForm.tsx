...
const AuthForm = ({ type }: { type: string }) => {
    ...
    return (
        <section className="auth-form">
            ...
            { /** * Renders a Plaid Link component to allow the user to link their bank
      account. * The Plaid Link component is wrapped in a div with a flex layout
      to center it. * The `user` prop is passed to the Plaid Link component,
      which is likely used to * associate the linked bank account with the
      user's account. * The `variant` prop is set to "primary" to apply the
      primary styling to the Plaid Link button. */ }
            {/* {user ? ( */}
